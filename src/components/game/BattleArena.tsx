...
export const BattleArena = ({ onBack }: BattleArenaProps) => {
  ...
  }, [battleState, kaiaPosition, playerHP, createParticle, createDamageNumber, triggerCameraShake, initializeTentacles]);
  ...
  }, [battleState, kaiaPosition, krakenPosition, enemyHP, createParticle, createSpeedlines, createDamageNumber, triggerCameraShake, executeEnemyAction]);
  ...
  }, [cameraShake, kaiaPosition, kaiaRotation, kaiaScale, krakenPosition, playerAction, enemyAction, particles, damageNumbers, speedlines, tentaclePositions]);
